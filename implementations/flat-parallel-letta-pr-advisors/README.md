...
This implementation package is the corrected flat-parallel PR advisory system: two independent Letta Code agents triggered in parallel by GitHub Actions.
...
- GitHub Actions secrets should be populated from Doppler or hydrated by a Doppler service token.
...
- `docs/qa/SELF_AUDIT.md` — rewrite integrity check.